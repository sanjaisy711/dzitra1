                ...
                <div className="sm:flex mt-4">
                    <div className="sm:w-1/2 picture-item p-4 rounded-md">
                        <div className="">
                            ...
                            <div className="pt-4 px-3">
                                <h5 className="mb-1 font-semibold text-xl"><Link href="#" className="hover:text-indigo-600 transition-all duration-500 ease-in-out">Dzitra Personal Portfolio</Link></h5>
                    ...
                    <div className="sm:w-1/2 picture-item p-4 rounded-md">
                        <div className="">
                            ...
                            <div className="pt-4 px-3">
                                <h5 className="mb-1 font-semibold text-xl"><Link href="#" className="hover:text-emerald-600 transition-all duration-500 ease-in-out">Dzitra Minimal Portfolio</Link></h5>
