...
import VideoModal from '../componets/construction/videoModal.js'
                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
                    <div className="lg:col-span-8 md:col-span-7 md:order-1 order-2">
                        <div className="md:me-6">
                            ...
                            <p className="text-slate-900 dark:text-white/75 text-lg max-w-xl">Start working with Dzitra that can provide everything you need to generate awareness, drive traffic, connect.</p>
                            ...
                            <div className="grid lg:grid-cols-12 grid-cols-1">
                                <div className="lg:col-span-4 order-1 lg:order-2 bg-indigo-600">
                                    <div className="p-[30px] lg:text-start text-center">
                                        ...
                                        <p className="text-white/75 max-w-xl mx-auto">Start working with Dzitra that can provide everything you need to generate awareness, drive traffic, connect.</p>
                                        <div className="mt-6">
