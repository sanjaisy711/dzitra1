                ...
                <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                    ...
                    <div className="lg:col-span-7">
                        <div className="lg:ms-10">
                            ...
                            <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">Buy Cryptocurrency <br /> with Dzitra</h3>
        ...
        <section className="relative md:py-24 py-16 md:pb-0 pb-0">
                ...
                <div className="grid md:grid-cols-12 grid-col-1 items-center gap-[30px]">
                    <div className="lg:col-span-5 md:col-span-6 order-2 md:order-1">
                        <div className="shadow dark:shadow-gray-800 rounded-md p-6 bg-gray-50 dark:bg-slate-800 overflow-hidden">
                            ...
                            <h5 className="text-center font-semibold text-2xl mt-3">Dzitra Token Sale</h5>
                    ...
                    <div className="lg:col-span-7 md:col-span-6 order-1 md:order-2">
                        <div className="lg:ms-10">
                            ...
                            <p className="text-slate-400 para-desc mx-auto mb-3">With Dzitra Trade, you can be sure your trading skills are matched with excellent service.</p>
                            <p className="text-slate-400 para-desc mx-auto">Dzitra Institutional Markets is a full-stack crypto services platform that works with crypto-native businesses and institutional clients on lending, trading, and custody solutions tailored to your needs.</p>
                            <div className="mt-4">
                                ...
                                <Link href="#"  onClick={() => setOpen(true)} data-type="youtube" data-id="S_CGed6E610" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-indigo-600 hover:bg-indigo-700 border border-indigo-600 hover:border-indigo-700 text-white m-1 lightbox"><Icon.Video className="size-4"></Icon.Video></Link><span className="font-semibold ms-1 align-middle">Watch Now</span>
                            </div>
            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="grid grid-cols-1 pb-8 text-center">
                    ...
                    <p className="text-slate-400 max-w-xl mx-auto">With Dzitra Trade, you can be sure your trading skills are matched with excellent service.</p>
                </div>
                        ...
                        {crypto.map((item,index)=>{
                            return(
                                <li className="inline-block md:m-6 my-6 mx-2" key={index}>
                                    <Image src={item} width={80} height={80} className="shadow-md dark:shadow-gray-800 rounded-full size-20 p-4" alt="" />
                                </li>
                            )
                        })}
                    </ul>
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 gap-[30px]">
                    <div className="flex">
                        ...
                        <div className="flex-1">
                            <h5 className="mb-2 text-xl font-semibold">How our <span className="text-indigo-600">Dzitra</span> work ?</h5>
                    ...
                    <div className="flex">
                        <Icon.HelpCircle className="fea icon-ex-md text-indigo-600 me-3"></Icon.HelpCircle>
                        <div className="flex-1">
                            <h5 className="mb-2 text-xl font-semibold"> Is <span className="text-indigo-600">Dzitra</span> safer to use with my account ?</h5>
