            ...
            <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute bottom-16 end-0">
                            ...
                            <div className="absolute bottom-2/4 translate-y-2/4 start-0 end-0 text-center">
                                <Link href="#" onClick={() => setOpen(true)} data-type="youtube" data-id="S_CGed6E610" className="lightbox size-14 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-indigo-600 dark:text-white">
                ...
                <div className="md:col-span-7">
                    <div className="lg:ms-4">
                        ...
                        <h4 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">Introducing Dzitra, <br /> A Fitness Center</h4>
    ...
    <section className="py-20 w-full table relative bg-center bg-no-repeat bg-fixed bg-cover" style={{backgroundImage:"url('/images/gym/cta.jpg')"}}>
        ...
        <div className="container relative">
            <div className="grid grid-cols-1 text-center">
                ...
                <p className="text-white/80 max-w-xl mx-auto">Start working with Dzitra that can provide everything you need to generate awareness, drive traffic, connect.</p>
                ...
                <Link href="#" onClick={() => setOpen(true)} data-type="youtube" data-id="S_CGed6E610" className="lightbox size-20 rounded-full shadow-md dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-indigo-600 mx-auto mt-10">
