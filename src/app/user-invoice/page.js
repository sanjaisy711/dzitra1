                                ...
                                <div className="md:flex justify-between">
                                    <div>
                                        ...
                                        <div className="flex mt-4">
                                            <Link href="#" className="size-4 me-3 mt-1"></Link>
                                            <Link href="#"className="text-indigo-600 dark:text-white font-medium">https://1.envato.market/Dzitra-next</Link>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-6 md:mt-0 md:w-56">
                                        ...
                                        <ul className="list-none">
                                            <li className="flex mt-3">
                                                <Icon.MapPin className="size-4 me-3 mt-1"></Icon.MapPin>
                                            ...
                                            <li className="flex mt-3">
                                                <Icon.Mail className="size-4 me-3 mt-1"></Icon.Mail>
                                                <Link href="/mailto:contact@example.com" className="text-slate-400">info@Dzitra.com</Link>
                                            </li>

                                            <li className="flex mt-3">
                                                <Icon.Phone className="size-4 me-3 mt-1"></Icon.Phone>
