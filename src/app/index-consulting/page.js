                            ...
                            <div className="picture-item p-4 rounded-md" key={index}>
                                <div className="">
                                    ...
                                    <div className="pt-4 px-3">
                                        <h5 className="mb-1 font-semibold text-lg"><Link href="#" className="hover:text-indigo-600 transition-all duration-500 ease-in-out">Dzitra Personal Portfolio</Link></h5>
