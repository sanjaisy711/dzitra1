        ...
        <section className="relative md:py-24 py-16">
            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="grid grid-cols-1 pb-8 text-center">
                    ...
                    <p className="text-slate-400 max-w-xl mx-auto">Write your own food blog with Dzitra that can provide everything you need to blog, news, article, etc.</p>
                </div>
                        ...
                        <div className="absolute bottom-0 start-0 end-0 p-6 -mb-96 group-hover:mb-0 duration-500 ease-in-out">
                            <div className="text-center">
                                ...
                                <div className="flex items-center justify-center mt-4">
                                    <Image src="/images/food/1.jpg" width={40} height={40} className="size-10 rounded-full shadow-md dark:shadow-gray-800" alt="" />
