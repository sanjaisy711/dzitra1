        ...
        <section className="relative md:h-screen md:py-0 py-36 items-center overflow-hidden bg-indigo-600  bg-center bg-no-repeat bg-cover" style={{backgroundImage:"url('/images/bg3.png')"}}>
            <div className="container relative">
                <div className="grid grid-cols-1 md:mt-36 mt-10 text-center">
                    <h4 className="font-bold text-white lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5">Integrated Dzitra <span className="text-orange-500">Software <br /> & Saas</span> Plateform </h4>
                    ...
                    <div className="overflow-hidden after:content-[''] after:absolute after:size-14 after:bg-white/20 after:-top-[40px] after:start-[30%] after:rounded-lg after:animate-[spin_10s_linear_infinite]"></div>
