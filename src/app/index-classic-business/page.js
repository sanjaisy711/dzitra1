                ...
                <div className="grid grid-cols-1">
                    <div className="flex items-center justify-between">
                        <ul className="list-none mb-0">
                            <li className="inline mb-0"><Link href="mailto:contact@example.com" className="text-slate-400 hover:text-indigo-600 inline-flex items-center"><FiMail className="size-4 me-1 text-indigo-600"/> contact@example.com</Link></li>
                            <li className="inline mb-0 ms-3"><Link href="tel:+152534-468-854" className="text-slate-400 hover:text-indigo-600 inline-flex items-center"><FiPhone className="size-4 me-1 text-indigo-600"/> +152 534-468-854</Link></li>
                        </ul>
