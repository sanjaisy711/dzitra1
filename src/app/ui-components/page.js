                                ...
                                <div className="grid grid-cols-1 gap-[30px]">
                                    ...
                                    <div className="shadow dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-md bg-indigo-600 hover:bg-indigo-700 border border-indigo-600 hover:border-indigo-700 text-white"><Icon.ShoppingCart className="size-4"/></Link>
                                                </li>
                                                
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-indigo-600 hover:bg-indigo-700 border border-indigo-600 hover:border-indigo-700 text-white"><Icon.ShoppingCart className="size-4"/></Link>
                                                </li>
                                                
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-md border bg-transparent hover:bg-indigo-600 border-indigo-600 text-indigo-600 hover:text-white"><Icon.ShoppingCart className="size-4"/></Link>
                                                </li>
                                                
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full border bg-transparent hover:bg-indigo-600 border-indigo-600 text-indigo-600 hover:text-white"><Icon.ShoppingCart className="size-4"/></Link>
                                                </li>
                                                ...
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-md border bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white"><Icon.ShoppingCart className="size-4"/></Link>
                                                </li>
                                                
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full border bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white"><Icon.ShoppingCart className="size-4"/></Link>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div className="grid grid-cols-1 gap-[30px]">
                                    ...
                                    <div className="shadow dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="dropdown inline-block relative m-0.5">
                                                    <button onClick={() => setManu11(!manu11)} className="dropdown-toggle size-9 inline-flex items-center justify-center tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md" type="button">
                                                        <AiOutlineSetting/>
                                                    </button>
                            ...
                            <div className="" id="breadcrumbs">
                                ...
                                <div className="grid grid-cols-1 gap-[30px]">
                                    <div className="shadow dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="tracking-[0.5px] mb-0 inline-flex items-center">
                                                <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out hover:text-indigo-600"><Link href="index.html">Dzitra</Link></li>
                                                <li className="inline-block text-base text-slate-950 dark:text-white mx-0.5 ltr:rotate-0 rtl:rotate-180"><MdKeyboardArrowRight/></li>
