...
export default function Page() {
    ...
    return (
        <>
            ...
            <section className="relative table w-full py-32 lg:py-40  bg-no-repeat bg-center bg-cover" style={{backgroundImage:"url('/images/portfolio/bg-inner.jpg')"}}>
                ...
                <div className="container relative">
                    <div className="grid grid-cols-1 pb-8 text-center mt-10">
                        ...
                        <p className="text-slate-300 text-lg max-w-xl mx-auto">Showcase of Our Awesome Works in Four Columns</p>
                    </div>
                </div>
            ...
            <PortfolioCreativeFilter className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-1 grid-cols-1 mt-4 gap-[30px]"/>
            <Footer />
            <Switcher/>
        </ >
    )
