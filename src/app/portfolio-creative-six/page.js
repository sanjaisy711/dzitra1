...
import PortfolioCreativeFilter from "../componets/portfolioCreativeFilter";
...
export default function Page() {
    return (
        <>
            ...
            <section className="relative table w-full py-32 lg:py-40  bg-no-repeat bg-center bg-cover" style={{backgroundImage:"url('/images/portfolio/bg-inner.jpg')"}}>
                ...
                <div className="container relative">
                    <div className="grid grid-cols-1 pb-8 text-center mt-10">
                        ...
                        <p className="text-slate-300 text-lg max-w-xl mx-auto">Showcase of Our Awesome Works in Six Columns</p>
                    </div>
                </div>

                <div className="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
                    <ul className="tracking-[0.5px] mb-0 inline-flex space-x-1 mx-auto">
            ...
            <PortfolioCreativeFilter containerClass={true} className="grid lg:grid-cols-6 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-4 gap-[30px] px-4 "/>
            <Footer />
            <Switcher/>
        </ >
    )
