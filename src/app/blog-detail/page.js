                ...
                <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                    <div className="lg:col-span-8 md:col-span-6">
                        <div className="p-6 rounded-md shadow dark:shadow-gray-800">
                            ...
                            <Image src="/images/blog/slide02.jpg" width={0} height={0} sizes="100vw" style={{width:"100%", height:"auto"}} className="rounded-md" alt="" />
                        ...
                        <div className="p-6 rounded-md shadow dark:shadow-gray-800 mt-8">
                            ...
                            <div className="mt-8">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center">
                                        <Image src="/images/client/01.jpg" height={44} width={44} className="size-11 rounded-full shadow" alt="" />
                            ...
                            <div className="mt-8">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center">
                                        <Image src="/images/client/02.jpg" height={44} width={44} className="size-11 rounded-full shadow" alt="" />
                            ...
                            <div className="mt-8">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center">
                                        <Image src="/images/client/03.jpg" height={44} width={44} className="size-11 rounded-full shadow" alt="" />
                            ...
                            <div className="mt-8">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center">
                                        <Image src="/images/client/04.jpg" height={44} width={44} className="size-11 rounded-full shadow" alt="" />
