                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
                    <div className="md:col-span-7 md:order-2 order-1">
                        <div className="ms-6">
                            ...
                            <p className="text-slate-400 text-lg max-w-xl">Dzitra is the largest provider of custom phone numbers since 2020</p>
        ...
        <section className="relative md:py-24 py-16">
            <div className="container relative">
                <div className="grid grid-cols-1 pb-8 text-center">
                    <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">Why People Choose Dzitra for Custom Numbers</h3>
