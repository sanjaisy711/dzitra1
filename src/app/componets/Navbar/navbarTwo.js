                        ...
                        <ul className="submenu megamenu">
                            <li>
                                <ul>
                                    ...
                                    <li className={manu === "/index-web-programming" || "" ? "active" : ""}><Link href="/index-web-programming" className="sub-menu-item">Web Programming <span className="bg-yellow-500 inline-block text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">New</span></Link></li>
                            ...
                            <li>
                                <ul>
                                    ...
                                    <li className={manu === "/index-cleaner" || "" ? "active" : ""}><Link href="/index-cleaner" className="sub-menu-item">Cleaner Service <span className="bg-yellow-500 inline-block text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">New</span></Link></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <ul>
                                    ...
                                    <li className={manu === "/index-life-coach" || "" ? "active" : ""}><Link href="/index-life-coach" className="sub-menu-item">Life Coach </Link></li>
                            ...
                            <li>
                                <ul>
                                    ...
                                    <li className={manu === "/index-landing-six" || "" ? "active" : ""}><Link href="/index-landing-six" className="sub-menu-item">Landing Six </Link></li>
                        ...
                        <ul className="submenu">
                            <li className={`${["page-aboutus", "page-services","page-team", "page-pricing", "page-testimonial"].includes(manu)? "active" : ""} has-submenu parent-menu-item`}><Link href="#"> Company </Link><span className="submenu-arrow"></span>
                                <ul className="submenu">
                                    ...
                                    <li className={`has-submenu child-menu-item ${["/page-services","/page-service-detail"].includes(manu)? "active" : ""}`}><Link href="#"> Services <span className="bg-indigo-600 inline-block text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">Added</span></Link><span className="submenu-arrow"></span>
                                        <ul className="submenu">
                                            <li className={manu === "/page-services" || "" ? "active" : ""}><Link href="/page-services" className="sub-menu-item">Services</Link></li>
                                            <li className={manu === "/page-service-detail" || "" ? "active" : ""}><Link href="/page-service-detail" className="sub-menu-item">Service Detail <span className="bg-yellow-500 inline-block text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">New</span></Link></li>
                                        </ul>  
                                    </li>
