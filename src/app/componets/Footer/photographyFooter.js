...
export default function PhotographyFooter(){
    return(
        <footer className="footer relative text-gray-400 dark:text-gray-400" style={{ background: `url('/images/photography/footer.jpg') top left` }}>
