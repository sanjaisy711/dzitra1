            ...
            <div className="lg:col-span-7 mt-8 lg:mt-0">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 md:gap-0 gap-[30px]">
                    ...
                    <div className="p-6 py-8">
                        ...
                        <li className="mb-1 flex items-center"><BsCheckCircle className="text-indigo-600 text-base me-2"/> Automate & digitise</li>
                        <li className="mb-1 flex items-center"><BsCheckCircle className="text-indigo-600 text-base me-2"/> Your business with minimal coding</li>
                        </ul>
