  ...
  return(
    ...
    <section className="relative md:pb-24 pb-16 overflow-hidden">
        ...
        <div className="container relative md:mt-24 mt-16">
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 items-center mt-16 gap-[30px]">
                ...
                <div className="lg:ms-8 wow animate__animated animate__fadeInRight" data-wow-delay=".3s">
                    <h3 className="mb-4 text-2xl leading-normal font-medium">Studio </h3>
                    <p className="text-slate-400">Optimize your workflows and keep your employees at peak productivity. Dzitra allows you to build apps that keep up with your business's fast pace and growth without a single line of code.</p>
                    <ul className="list-none text-slate-400 mt-4">
                        <li className="mb-1 flex items-center"><BsCheckCircle className="text-indigo-600 text-base me-2"/><i ></i> Design, develop, test and deploy apps</li>
                        <li className="mb-1 flex items-center"><BsCheckCircle className="text-indigo-600 text-base me-2"/><i ></i> Get your apps up and running 10X faster</li>
                        <li className="mb-1 flex items-center"><BsCheckCircle className="text-indigo-600 text-base me-2"/><i ></i>  tailored to your business</li>
                    </ul>
        ...
        <div className="container relative md:mt-24 mt-16">
            <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                ...
                <div className="lg:me-8 order-2 md:order-1 wow animate__animated animate__fadeInLeft" data-wow-delay=".5s">
                    <h3 className="mb-4 text-2xl leading-normal font-medium">Form & Process</h3>
                    <p className="text-slate-400">Collaborate through employee dashboards, portals and processes. Build your apps from scratch or choose from hundreds of pre-built templates.</p>
                    <ul className="list-none text-slate-400 mt-4">
        ...
        <div className="container relative md:mt-24 mt-16">
          <div className="grid md:grid-cols-2 grid-cols-1 items-center mt-16 gap-[30px]">
                <div className="relative wow animate__animated animate__fadeInLeft" data-wow-delay=".3s">
                    <Image src="/images/saas/classic04.png" width={0} height={0} sizes="100vw" style={{width:"100%",height:"auto"}} className="rounded-lg shadow-md dark:shadow-gray-800" alt="" />
                    <div className="overflow-hidden absolute lg:size-[400px] size-[320px] bg-indigo-600/5 bottom-0 start-0 rotate-45 -z-1 rounded-3xl"></div>
                </div>
        ...
        <div className="container relative md:mt-24 mt-16">
            <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                ...
                <div className="lg:me-8 order-2 md:order-1 wow animate__animated animate__fadeInLeft" data-wow-delay=".5s">
                    <h3 className="mb-4 text-2xl leading-normal font-medium">Board</h3>
                    <p className="text-slate-400">Collaborate through employee dashboards, portals and processes. Build your apps from scratch or choose from hundreds of pre-built templates.</p>
                    <ul className="list-none text-slate-400 mt-4">
                        <li className="mb-1 flex items-center"><BsCheckCircle className="text-indigo-600 text-base me-2"/><i ></i> Digital Marketing Solutions for Tomorrow</li>
                        <li className="mb-1 flex items-center"><BsCheckCircle className="text-indigo-600 text-base me-2"/><i ></i> Our Talented & Experienced Marketing Agency</li>
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                ...
                <div className="lg:me-8 order-2 md:order-1 wow animate__animated animate__fadeInLeft" data-wow-delay=".5s">
                    ...
                    <ul className="list-none text-slate-400 mt-4">
                        ...
                        <li className="mb-1 flex items-center"><BsCheckCircle className="text-indigo-600 text-base me-2"/><i ></i>Collaborate with your team to build your apps on a single, unified platform</li>
                        <li className="mb-1 flex items-center"><BsCheckCircle className="text-indigo-600 text-base me-2"/><i ></i>Accelerate development and minimize your costs and time to deployment</li>
                    </ul>
                </div>
            </div>
        </div>
