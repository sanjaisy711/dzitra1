...
export default function Page() {
  ...
  const images = [
    '/images/cleaner/bg1.png',
    '/images/cleaner/bg2.png',
    '/images/cleaner/bg3.png',
  ];
  ...
  return (
    <>
     ...
     <section className="relative flex items-center w-full py-36 lg:py-0 lg:h-screen" id="home" style={{backgroundImage:`url(${images[currentImageIndex]})`}}>
        ...
        <div className="absolute inset-0 bg-center bg-no-repeat bg-cover -z-1" style={{backgroundImage:`url('/images/cleaner/bg.png')`}}></div>
        ...
        <div className="container relative">
            <div className="grid grid-cols-1 pb-8 text-center mt-14">
                ...
                <div className="mt-8">
                    <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-yellow-500 hover:bg-yellow-600 border-yellow-500 hover:border-yellow-600 text-white rounded-md">Get an Quote</Link>
                </div>
            </div>
        </div>
    </section>
            ...
            <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                <div className="lg:col-span-5 md:col-span-6">
                    <div className="relative">
                        <div className="relative">
                            <Image src='/images/cleaner/ab1.jpg' width={0} height={0} sizes="100vw" style={{width:'400px', height:'auto'}} className="lg:w-[400px] w-[280px] rounded-md" alt=""/>
                            <div className="absolute top-0 translate-y-2/4 end-0 text-center">
                                <Link href="#!" scroll={false} onClick={() => setOpen(true)} className="lightbox size-20 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-indigo-600 dark:text-white">
                        ...
                        <div className="absolute -end-5 -bottom-16 rounded-md">
                            <Image src='/images/cleaner/ab2.jpg' width={0} height={0} sizes="100vw" style={{width:'280px' , height:'auto'}} className="lg:w-[280px] w-[200px] border-8 border-white dark:border-slate-900 rounded-md" alt=""/>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:col-span-7 md:col-span-6 mt-8 md:mt-0">
                    <div className="lg:ms-6">
                        ...
                        <p className="text-slate-400 max-w-xl">You can combine all the Dzitra templates into a single one, you can take a component from the Application theme and use it in the Website.</p>
    ...
    <section className="py-20 w-full table relative bg-fixed bg-center bg-no-repeat bg-cover" style={{backgroundImage:`url('/images/cleaner/bg.jpg')`}}>
                        ...
                        <div className="group relative" key={index}>
                            ...
                            <div className="relative -mt-6 px-6">
                                <div className="rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900 p-6">
                                    <Link href="#" className="title h5 text-lg font-semibold hover:text-indigo-600 duration-500 ease-in-out">{item.title}</Link>
                        ...
                        <div className="lg:col-span-3 md:col-span-6" key={index}>
                            <div className="group text-center">
                                <div className="relative inline-block mx-auto size-52 rounded-full overflow-hidden">
                                    <Image src={item.image} className="" width={0} height={0} sizes="100vw" style={{width:'100%', height:'auto'}} alt=""/>
                                    ...
                                    <ul className="list-none absolute start-0 end-0 -bottom-20 group-hover:bottom-5 duration-500">
                                        <li className="inline"><Link href="#" className="size-8 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full border border-indigo-600 bg-indigo-600 hover:border-indigo-600 hover:bg-indigo-600 text-white"><FiFacebook className="size-4"/></Link></li>
                                        <li className="inline"><Link href="#" className="size-8 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full border border-indigo-600 bg-indigo-600 hover:border-indigo-600 hover:bg-indigo-600 text-white"><FiInstagram className="size-4"/></Link></li>
                                        <li className="inline"><Link href="" className="size-8 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full border border-indigo-600 bg-indigo-600 hover:border-indigo-600 hover:bg-indigo-600 text-white"><FiLinkedin className="size-4"/></Link></li>
                                    </ul>
                                </div>
