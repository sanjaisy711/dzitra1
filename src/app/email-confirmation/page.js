                ...
                <tbody>
                    ...
                    <tr>
                        <td style={{padding: '15px 24px 15px',  color: '#8492a6'}}>
                            Thanks for creating an Dzitra account. To continue, please confirm your email address by clicking the button below :
                        </td>
                    </tr>

                    <tr>
                        <td style={{padding: '15px 24px'}}>
                            <Link href="#"  style={{padding: '8px 20px',  outline: 'none', textDecoration: 'none', fontSize: '16px', letterSpacing: 0.5+ 'px', transition: 'all 0.3s', fontWeight: 600,  borderRadius: 6+ 'px', backgroundColor: '#4f46e5', border: '1px solid #4f46e5', color: '#ffffff'}}>Confirm Email Address</Link>
                        </td>
                    </tr>
