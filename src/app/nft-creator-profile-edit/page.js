                        ...
                        <div className="p-6 rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900 mt-[30px]">
                                ...
                                <div className="md:w-2/3 mt-4 md:mt-0">
                                    <form>
                                        <div className="form-icon relative">
                                            <i data-feather="twitter" className="size-4 absolute top-3 start-4"></i>
                            ...
                            <div className="md:flex mt-8">
                                ...
                                <div className="md:w-2/3 mt-4 md:mt-0">
                                    <form>
                                        <div className="form-icon relative">
                                            <i data-feather="facebook" className="size-4 absolute top-3 start-4"></i>
                            ...
                            <div className="md:flex mt-8">
                                ...
                                <div className="md:w-2/3 mt-4 md:mt-0">
                                    <form>
                                        <div className="form-icon relative">
                                            <i data-feather="instagram" className="size-4 absolute top-3 start-4"></i>
                            ...
                            <div className="md:flex mt-8">
                                ...
                                <div className="md:w-2/3 mt-4 md:mt-0">
                                    <form>
                                        <div className="form-icon relative">
                                            <i data-feather="linkedin" className="size-4 absolute top-3 start-4"></i>
                            ...
                            <div className="md:flex mt-8">
                                ...
                                <div className="md:w-2/3 mt-4 md:mt-0">
                                    <form>
                                        <div className="form-icon relative">
                                            <i data-feather="youtube" className="size-4 absolute top-3 start-4"></i>
