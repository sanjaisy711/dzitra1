                        ...
                        <div className="grid md:grid-cols-12 grid-cols-1 items-center">
                            ...
                            <div className="lg:col-span-5 md:col-span-6">
                                ...
                                <div className="flex justify-center text-center p-6 border-t border-gray-100 dark:border-gray-800">
                                    <p className="mb-0 text-slate-400">© {new Date().getFullYear()} Dzitra. Design & Develop with <i className="mdi mdi-heart text-red-600"></i> by <Link href="/https://shreethemes.in/" target="_blank"
