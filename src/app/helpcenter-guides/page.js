                ...
                <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[30px]">
                    ...
                    <div className="">
                        ...
                        <ul className="list-none mt-4">
                            ...
                            <li className="mt-2"><Link href="#" className="text-slate-400"><i className="mdi mdi-arrow-right text-indigo-600 me-2"></i>Dzitra Plus</Link></li>
                    ...
                    <div className="">
                        ...
                        <ul className="list-none mt-4">
                            <li className="mt-2"><Link href="#" className="text-slate-400"><i className="mdi mdi-arrow-right text-indigo-600 me-2"></i>Dzitra safely</Link></li>
                            <li className="mt-2"><Link href="#" className="text-slate-400"><i className="mdi mdi-arrow-right text-indigo-600 me-2"></i>Dzitra Experiences and Adventures</Link></li>
