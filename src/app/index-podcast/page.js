                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center md:gap-[30px] gap-12">
                                ...
                                <div className="bg-white dark:bg-slate-800 w- rounded-xl shadow-md dark:shadow-gray-800 w-[300px] border-b border-gray-100 dark:border-gray-600">
                                    <div className="p-6 space-y-6">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <h5 className="text-xl font-semibold">Dzitra Podcast</h5>
                                        </div>
                    ...
                    <div className="md:col-span-7">
                        <div className="lg:ms-4">
                            ...
                            <p className="text-slate-400 max-w-xl mb-2">Dzitra Homes developed a platform for the Real Estate marketplace that allows buyers and sellers to easily execute a transaction on their own.</p>
                            <p className="text-slate-400 max-w-xl">The platform drives efficiency, cost transparency and control into the hands of the consumers. Dzitra Homes is Real Estate Redefined.</p>
        ...
        <section className="relative md:py-24 py-16">
            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="grid md:grid-cols-12 grid-cols-1 items-center">
                    ...
                    <div className="md:col-span-6">
                        <p className="text-slate-400 max-w-xl">Start working with Dzitra that can provide everything you need to generate awareness, drive traffic, connect.</p>
                    </div>
                </div>
