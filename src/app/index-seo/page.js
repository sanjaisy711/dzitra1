                                ...
                                <ul className="space-y-8" key={index}>
                                    <li className="shadow dark:shadow-gray-800 p-6">
                                        <div className="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                            <Image src={item.image} height={64} width={64} className="size-16 rounded-full shadow dark:shadow-gray-800" alt="" />
                                    ...
                                    <li className="shadow dark:shadow-gray-800 p-6">
                                        <div className="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                            <Image src={item.image1} height={64} width={64} className="size-16 rounded-full shadow dark:shadow-gray-800" alt="" />
